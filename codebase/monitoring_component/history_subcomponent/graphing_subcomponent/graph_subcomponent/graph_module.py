...
def createstatuslegend(horizontaloffset, graphbottom):
	...
	outcome.additem('red', Draw.rectangle(horizontaloffset + 890, graphbottom - 138, 5, 7))
	outcome.additem('graphlegends', Draw.text(horizontaloffset + 900, graphbottom - 131, 'Other-Error'))

	outcome.additem('orange', Draw.rectangle(horizontaloffset + 790, graphbottom - 138, 5, 7))
	outcome.additem('graphlegends', Draw.text(horizontaloffset + 800, graphbottom - 131, 'Invalid-Argument'))

	outcome.additem('amber', Draw.rectangle(horizontaloffset + 690, graphbottom - 138, 5, 7))
